...
function Searchbar(props) {
    ...
    if(items){
        ...
        items=items.splice(0,3).map((e)=>{
            setbackdrop(backdrop.concat(e.backdrop_path))
            return backdrop
        });
    }
  ...
  <div className="carousel-inner" data-bs-interval="10000">
    ...
    {/* <Select options={options} /> */}
          ...
          <input placeholder="Search" type="search" class="input" value={input} onChange={handleChange}/>
    <div className='searched'>
      {data.slice(0,20).map((element)=>{
      {console.log("you data has been ",data)}
